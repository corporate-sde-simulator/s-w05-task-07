# Architecture Decision Record - Tax calculation engine for multi-region
...
Implement Tax calculation engine for multi-region using industry-standard patterns appropriate for typescript and our platform requirements.
